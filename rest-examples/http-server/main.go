...
import (
	...
	"github.com/bygui86/go-testing/rest-examples/http-server/config"
	...
	"github.com/bygui86/go-testing/rest-examples/http-server/monitoring"
	"github.com/bygui86/go-testing/rest-examples/http-server/rest"
	"github.com/bygui86/go-testing/rest-examples/http-server/tracing"
)
...
func startRestServer() *rest.Server {
	...
	server := rest.New(rest.LoadConfig(), database.New())
